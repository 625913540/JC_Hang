    ...
    <script type="text/javascript">
	 var _menus = {"menus":[
						{"menuid":"1","icon":"icon-sys","menuname":"系统管理",
							"menus":[
									{"menuid":"11","menuname":"用户管理","icon":"icon-users","url":"html_admin_listadmin.do"},
							...
							"menus":[{"menuid":"21","menuname":"咨询学生管理","icon":"icon-nav","url":"html/employee/listEmployee.html"},
						...
						},{"menuid":"3","icon":"icon-sys","menuname":"学工部",
							"menus":[{"menuid":"31","menuname":"在校学生管理","icon":"icon-nav","url":"html/role/listRole.html"},
									{"menuid":"32","menuname":"学生升/留级","icon":"icon-nav","url":"html/role/listRolePri.html"},
									{"menuid":"33","menuname":"学生流失情况","icon":"icon-nav","url":"html/privilege/listPrivilege.html"},
									]
